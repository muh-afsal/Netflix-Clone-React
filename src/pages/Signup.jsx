        ...
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 rounded text-white'>
           <div className='max-w-[320px] mx-auto py-20'> 
              ...
              <form onSubmit={handleSubmit} className='w-full flex flex-col p-4' >
                <input onChange={(e)=>setEmail(e.target.value)} className='p-3 my-3 bg-gray-500/30 rounded' type="email" placeholder='Email' autoComplete='email' />
                <input onChange={(e)=>setPassword(e.target.value)} className='p-3 my-3 bg-gray-500/30 rounded' type="password" placeholder='Password' autoComplete='current-password'/>
                <button className='bg-red-600 py-2 my-6 rounded font-bold' >Sign Up</button>
                <div className='flex justify-between text-gray-600 text:sm '>
                    <p><input className='mr-2' type="checkbox"/>Remember me</p>
                    <p>Need Help?</p>
                </div>
                <p className='text-sm py-6 text-gray-600'>Already subscribed to Netflix? <span className='text-white'><Link to='/login' >Sign In</Link></span></p>
              </form>
           </div>
        </div>
